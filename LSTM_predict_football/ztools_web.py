...
def web_get001txtFg(uss,fss):
    ...
    if zsys.web_get001txtFg or(fsiz<1000):
        ...
        htm=web_get001txt(uss,ftg=fss,fcod='UTF-8');#print(fss)
    else:
        htm=zt.f_rd(fss,cod='UTF-8')    
    #
    return htm
...
#    return tag.has_attr(zsys.bs_get_ktag_kstr[0]) and tag.get(zsys.bs_get_ktag_kstr[0]) == zsys.bs_get_ktag_kstr[1]
